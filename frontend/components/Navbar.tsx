...
const DROPDOWNS = {
  ...
  genre: [
    ...
    { label: 'History', href: '/genre/history' },
  ...
  quality: [
    { label: '2160p 4K', href: '/quality/2160p' },
    { label: '60Fps', href: '/quality/60fps' },
    { label: '1080p', href: '/quality/1080p' },
    { label: '720p', href: '/quality/720p' },
    { label: '480p', href: '/quality/480p' },
  ] as DropdownItem[],
};
